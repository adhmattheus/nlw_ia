...
export function VideoInputForm() {
  ...
  function handleFileSlected(event: ChangeEvent<HTMLInputElement>) {
  ...
  return (
    <form className="space-y-6" onSubmit={handleUploadVideo}>
      <label
        ...
        {previewURL ? (
          <video src={previewURL} controls={false} className="pointer-events-none abosolute inset-8" />
        ) : (
          <>
      ...
      <input type="file" id="video" accept="video/mp4" className="sr-only" onChange={handleFileSlected} />
